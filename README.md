...
- [TobiasTomski (C)](https://github.com/TobiasTomski/C-Stuff/blob/master/pi_to_n_digits.c)
...
- [Raul-Popa (C#)](https://github.com/Raul-Popa/Next-Prime/blob/master/NextPrime.cs)
...
- [MarcinMisiorny (PL/SQL)](https://github.com/MarcinMisiorny/Main/blob/master/Mega%20Project%20List/Classic%20Algorithms/1.%20Collatz%20Conjecture.sql)
...
- [inishchith (C)](https://github.com/inishchith/C-Basics/blob/master/SieveOfEratosthenes.c)
...
- [Dotman14 (C++)](https://github.com/dotman14/Solution-to-random-programming-problems/blob/master/reverse.cpp)
...
- [tiikeri (Bash)](https://github.com/tiikeri/all/blob/master/coding-problems-solved/projects-solutions/pdrome.sh)
...
- [bhaskar4n-linked (Python)](https://github.com/bhaskar4n/address-book-database-linked)
...
- [tiikeri (Python)](https://github.com/tiikeri/pythonscripts/blob/master/caesar.py)
- [mandliya(C++)](https://github.com/mandliya/short-fun-projects/blob/master/caesarCipher/caesarCipher.cpp)
- [mandeepbhutani (Python)](https://github.com/mandeepbhutani/Sample-Projects/blob/master/caesar_cipher.py)
- [Waid0 (C++)](https://github.com/Waid0/project-solutions/blob/master/solutions.hpp)
- [bl4ckbo7 (Visual Basic)](https://github.com/bl4ckbo7/Caesar-Cipher-w-Bruteforcer/blob/master/caesarcipher.vb)

**XOR Cipher** - Implement the XOR cipher. The key is a variable length of text such as "dog". To encode a message the messaged is XORed with the key. For example if my message was "attack at dawn" - 14 letters, I would cycle "dog" until I had 14 characters so "dogdogdogdogdo". Then you convert each letter into binary using ascii. So the first character of message is "a" or 97 in ascii. When you convert 97 in binary you get 01100001. The first character of the key is "d" or 100 in asciii in binary that is 01100100. Now that you have the two characters in binary we can XOR them!. XOR is defined as follows for 0 and 0 you get 0, for 0 and 1 you get 1, for 1 and 0 you get 0 and for 1 and 1 you get 0. When you xor 01100001 and 01100100 you get 00000101 or "\enq" in ascii. "\enq is just a formatting character in ascii. To decrypt you xor the encoded message and the key to get the decoded message.
